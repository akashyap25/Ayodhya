  ...
  return (
    <>
      <div className='flex flex-col lg:flex-row lg:space-x-4 justify-center items-center text-center lg:w-2/3 mx-auto p-8 mt-24'>
        <div className='lg:w-1/4 bg-white rounded-lg shadow-lg shadow-red-500 p-4'>
        ...
        <div className='lg:w-1/4 bg-white rounded-lg shadow-lg shadow-red-500 p-4 mt-4 lg:mt-0'>
